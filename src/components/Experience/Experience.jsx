...
const Internship = () => {
  return (
    <Section id="internship" title="INTERNSHIP" subtitle="Professional internships that shaped my career and skills" paddingTop="pt-8" paddingBottom="pb-0" className="relative">
        ...
        {internships.map((exp) => (
          ...
          >
            <div className="flex items-center space-x-6">
              <div className="w-20 h-12 bg-white overflow-hidden">
                <img
                  src={exp.img}
                  alt={exp.company}
